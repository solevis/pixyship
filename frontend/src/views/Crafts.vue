      ...
      <template v-slot:item="{ item }">
        <tr>
          ...
          <td>{{ item.hp }}</td>
              ...
              <td>{{ item.speed }}<br><span class="damage-dps">{{ `${computeDps(item.speed, item)}/s` }}</span></td>
              <td>{{ item.fire_length }}<br><span class="damage-dps">{{ `${computeDps(item.fire_length, item)}/s` }}</span></td>
              <td>{{ item.emp_length }}<br><span class="damage-dps">{{ `${computeDps(item.emp_length, item)}/s` }}</span></td>
        </tr>
      </template>
    </v-data-table>
  </v-card>
